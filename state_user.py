...
CHANNELS_STR = f"𓆩 **[ Multi HUNTER](t.me/r6r6rr)** **- 🝢 - احصـائيـات جميـع القنـوات** 𓆪\n\n"
CHANNELS_ADMINSTR = f"𓆩 **[ Multi HUNTER](t.me/r6r6rr)** **- 🝢 - احصـائيـات جميـع القنـوات اشـراف** 𓆪\n\n"
CHANNELS_OWNERSTR = f"𓆩 **[ Multi HUNTER](t.me/r6r6rr)** **- 🝢 - احصـائيـات جميـع القنـوات ملكيـة** 𓆪\n\n"
GROUPS_STR = f"𓆩 **[ Multi HUNTER](t.me/r6r6rr)** **- 🝢 - احصـائيـات جميـع المجمـوعـات** 𓆪\n\n"
GROUPS_ADMINSTR = f"𓆩 **[ Multi HUNTER](t.me/r6r6rr)** **- 🝢 - احصـائيـات جميـع المجمـوعـات اشـراف** 𓆪\n\n"
GROUPS_OWNERSTR = f"𓆩 **[ Multi HUNTER](t.me/r6r6rr)** **- 🝢 - احصـائيـات جميـع المجمـوعـات ملكيـة** 𓆪\n\n"
...
async def count(event):
    ...
    result += f"𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 SVJ **- 🝢 - احصـائيـات الحسـاب** 𓆪\n"
...
async def stats(event):
    ...
    response = f"𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 SVJ **- 🝢 - معلومات {full_name}** 𓆪\n"
